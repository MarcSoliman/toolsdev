...
class SmartSaveUI(QtWidgets.QDialog):
    ...
    def _save(self):
        ...
        self.scenefile.descriptor = self.descripor_le.text()
    ...
    def _create_filename_ui(self):
        ...
        self.descripor_le = QtWidgets.QLineEdit(self.scenefile.descriptor)
        self.descripor_le.setMinimumWidth(100)
        ...
        layout.addWidget(self.descripor_le, 1, 0)
...
class SceneFile(object):
    ...
    def next_avail_ver(self):
        """Return the next avilable version number in the folder."""
    ...
    def increment_save(self):
        ...
        if the existing version of file exists, it should increment
        from the largest version number from folder.
        Returns:
            path: The path to the scene file if successful
        """
